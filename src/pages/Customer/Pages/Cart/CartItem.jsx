...
import {
    InputNumber, Button, Popconfirm, Space, Select, Checkbox, Tag
} from 'antd';
import {
    DeleteOutlined, HeartOutlined, HeartFilled, PlusOutlined, MinusOutlined
        ...
        <div className="cart-item">
            <div className="cart-item-inner">
                ...
                <div className="cart-item-img">
                    <img
                        src={variant?.image_url || 'https://placehold.co/600x400?text=No+Image'}
