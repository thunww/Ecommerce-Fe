...
const ShipperRegister = () => {
  ...
  // Kiểm tra nếu user đã là shipper active thì chuyển hướng về dashboard
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      dispatch(registerShipper(formData));
    }
  };
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Thông tin địa chỉ */}
            <div className="bg-red-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-red-900 mb-4">Thông tin địa chỉ</h3>
