            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-gradient-to-r from-white to-blue-50 text-gray-500">Or sign up with</span>
                </div>
              </div>
              ...
              <p className="text-center text-gray-600">
                ...
                <Link to="/login" className="text-indigo-600 font-medium hover:text-indigo-800 hover:underline transition duration-150">
                  Login here
                </Link>
              </p>
            </div>
