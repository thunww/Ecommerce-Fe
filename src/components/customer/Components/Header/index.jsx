...
import { FaUser, FaSignOutAlt, FaClipboardList, FaShoppingBag, FaChevronDown, FaChevronUp } from "react-icons/fa";
                        ...
                        <div className='col2 hidden sm:flex items-center justify-end'>
                            <ul className='flex items-center gap-2 sm:gap-3'>
                                <li className='list-none'>
                                    <Link to="/help-center" className='text-white text-[10px] sm:text-[12px] link font-[500] transition'>Help Center</Link>
                                </li>
                                <li className='list-none'>
                                    <Link to="/order-tracking" className='text-white text-[10px] sm:text-[12px] link font-[500] transition'>Order Tracking</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-wrap items-center justify-between gap-2'>
                        ...
                        <div className='w-[120px] sm:w-[150px] flex-shrink-0'>
                            <Link to="/" className='logo block'>
                                <img src='/logo.jpg' alt='logo' className="max-h-10 sm:max-h-12 w-auto" />
                            </Link>
                        </div>
                                ...
                                {isAuthenticated ? (
                                    <li className='list-none relative' ref={menuRef}>
                                        ...
                                        >
                                            ...
                                            <span className="truncate max-w-[40px] xs:max-w-[80px] sm:max-w-none">My Account</span>
                                            {showAccountMenu ? <FaChevronUp className="text-xs flex-shrink-0" /> : <FaChevronDown className="text-xs flex-shrink-0" />}
                                        </button>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        >
                                                            ...
                                                            <span className="truncate">Danh sách yêu thích</span>
                                                        </Link>
                                                    </li>
                                    ...
                                    <li className='list-none'>
                                        <div className="flex items-center text-[11px] sm:text-[14px]">
                                            <Link to="/login" className='text-black link font-[500] transition'>Login</Link>
                                            <span className="px-1">|</span>
                                            <Link to="/register" className='text-black link font-[500] transition'>SignUp</Link>
                                        </div>
                                    </li>
                                )}
                            </ul>
