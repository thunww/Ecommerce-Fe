  ...
  return (
    <div className="productItem  shadow-lg py-5 rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] flex items-center">
      <div className="group imgWrapper w-[25%]  overflow-hidden rounded-md relative">
        <Link to="/">
          <div className="img h-[200px] overflow-hidden">
            <img
              src="https://img.lazcdn.com/g/p/69b28ff2c70a97b0b0078facbdb35ad7.jpg_400x400q80.jpg_.avif"
              className=" w-full"
            />
            {/* w-full */}

            <img
              src="https://img.lazcdn.com/g/p/ec25d123320dcd986c5323a2ac3e4dd8.jpg_400x400q80.jpg_.avif"
        ...
        <div
          className="actions absolute top-[-200px] right-[5px] z-50 flex items-center gap-2 flex-col w-[50px]
                  transition-all duration-300 group-hover:top-[15px] opacity-0 group-hover:opacity-100"
        >
          <Button
            className="!w-[35px] !h-[35px] !min-w-[35px] !rounded-full !bg-white group text-black
      ...
      <div className="info p-3 py-5 px-8 w-[75%]">
        ...
        <p className="text-[14px]">san pham duoc nhap tu kho quang chau</p>
